    ...
    <div className='w-full h-screen bg-zinc-900 pt-1'>
        <div className='textstructure mt-52 px-20'>
            {["We Create","Eye-Opening","Presentations"].map((item,index)=>{
                return  (<div className='masker bg-red-600'>
                          <div className='w-fit flex'>
                            {index === 1 && <div className='w-[9vw] h-[6vw] relative -top-[1vw] bg-red-500'>
                              </div>}
                            <h1 className='flex items-center uppercase text-[9vw] h-full leading-[7vw] font-["Founders Grotesk X-Condensed"] font-bold'>{item}</h1>                                    
                          </div>
                        </div>)
            })}
        </div>
